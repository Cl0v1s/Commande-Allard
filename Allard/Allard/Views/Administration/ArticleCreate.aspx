...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <div>
        <h2>Titre</h2>
        <asp:TextBox runat="server" ID="Title" name="title"  placeholder="Choisissez un titre pour votre article..." />
    </div>
    <div>
        <h2>Resumé</h2>
    ...
    <div>
        <h2>Contenu</h2>
        <asp:TextBox runat="server" ID="Content" placeholder="Vous pouvez rédiger ici le contenu de votre article..."></asp:TextBox>
    </div>
    <div>
